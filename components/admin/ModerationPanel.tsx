...
export default function ModerationPanel() {
  ...
  useEffect(() => {
    loadUserPermissions();
    loadModerationData();
  // eslint-disable-next-line react-hooks/exhaustive-deps -- functions defined below
  }, []);
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps -- loadModerationData defined below
  }, [isAdmin]);
