...
const variantConfig = {
  ...
  success: {
    bg: 'bg-[color-mix(in_oklab,var(--nn-green)_22%,transparent)]',
    border: 'border-[color-mix(in_oklab,var(--nn-green)_50%,transparent)]',
    text: 'text-[color:var(--nn-green)]',
  ...
  error: {
    bg: 'bg-[color-mix(in_oklab,var(--nn-magenta)_22%,transparent)]',
    border: 'border-[color-mix(in_oklab,var(--nn-magenta)_50%,transparent)]',
    text: 'text-[color:var(--nn-magenta)]',
