...
export const players = pgTable('players', {
	...
	shrineBoosts: jsonb('shrine_boosts').notNull().$type<any[]>().default([]),
	units: jsonb('units').notNull().$type<any[]>().default([]),
	totalStrength: integer('total_strength').notNull().default(0),
	totalDefense: integer('total_defense').notNull().default(0),
	balanceEffects: jsonb('balance_effects').$type<any>(),
