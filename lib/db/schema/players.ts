...
export const players = pgTable('players', {
	...
	bankLastDeposit: timestamp('bank_last_deposit', { withTimezone: true }),
	...
	activeBoostsExpiresAt: timestamp('active_boosts_expires_at', { withTimezone: true }),
	...
	lastXPAward: timestamp('last_xp_award', { withTimezone: true }),
	...
	vipExpiration: timestamp('vip_expiration', { withTimezone: true }),
	vipTier: varchar('vip_tier', { length: 20 }),
	stripeCustomerId: varchar('stripe_customer_id', { length: 255 }),
	stripeSubscriptionId: varchar('stripe_subscription_id', { length: 255 }),
	vipLastUpdated: timestamp('vip_last_updated', { withTimezone: true }),
	lastLoginDate: timestamp('last_login_date', { withTimezone: true }),
	loginStreak: integer('login_streak').default(0),
	lastStreakReward: timestamp('last_streak_reward', { withTimezone: true }),
	...
	lastFlagAttack: timestamp('last_flag_attack', { withTimezone: true }),
	...
	referralValidatedAt: timestamp('referral_validated_at', { withTimezone: true }),
	...
	lastReferralValidated: timestamp('last_referral_validated', { withTimezone: true }),
