...
export const missiles = pgTable('missiles', {
  ...
  impactAt: timestamp('impact_at', { withTimezone: true }),
  ...
  interceptedAt: timestamp('intercepted_at', { withTimezone: true }),
...
export const playerResearch = pgTable('player_research', {
  ...
  currentResearchStartedAt: timestamp('current_research_started_at', { withTimezone: true }),
...
export const wmdSpies = pgTable('wmd_spies', {
  ...
  recruitedAt: timestamp('recruited_at', { withTimezone: true }).notNull(),
  createdAt: timestamp('created_at', { withTimezone: true }).notNull(),
  updatedAt: timestamp('updated_at', { withTimezone: true }).notNull(),
}, (table) => [
