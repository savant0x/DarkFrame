...
export default function HelpPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-bg-space to-black text-white p-8">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-glass-light rounded-lg p-6 border-2 border-cyan-500/30">
            ...
            <div className="space-y-2 text-text-primary">
              ...
              <p>2. <strong>Gather resources</strong> by pressing <kbd className="bg-glass-light px-2 py-1 rounded">G</kbd> on Metal/Energy tiles</p>
              <p>3. <strong>Build units</strong> at your base by pressing <kbd className="bg-glass-light px-2 py-1 rounded">U</kbd></p>
              <p>4. <strong>Explore caves/forests</strong> by pressing <kbd className="bg-glass-light px-2 py-1 rounded">F</kbd> for rare items</p>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">Q</kbd>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-text-secondary">Move West:</span>
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">A</kbd>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-text-secondary">Move South:</span>
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">Z</kbd>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-text-secondary">Move East:</span>
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">C</kbd>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-text-secondary">Move NE/NW/SE/SW:</span>
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">W E D X</kbd>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-text-secondary">Return to Base:</span>
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">Shift+H</kbd>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">G</kbd>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-text-secondary">Explore Cave/Forest:</span>
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">F</kbd>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-text-secondary">Attack Factory:</span>
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">R</kbd>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-text-secondary">Open Bank:</span>
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">B</kbd>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-text-secondary">Visit Shrine:</span>
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">S</kbd>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">U</kbd>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-text-secondary">Manage Factory:</span>
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">M</kbd>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-text-secondary">Specialization:</span>
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">N</kbd>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-text-secondary">Tier Unlock:</span>
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">T</kbd>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-text-secondary">Inventory:</span>
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">I</kbd>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-text-secondary">Discovery Log:</span>
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">V</kbd>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-text-secondary">Achievements:</span>
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">H</kbd>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">ESC</kbd>
                  </div>
                  <div className="flex justify-between">
              ...
              <div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">Shift+R</kbd>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-text-secondary">Toggle Stats:</span>
                    <kbd className="bg-glass-light px-3 py-1 rounded font-mono">Shift+S</kbd>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-glass-light rounded-lg p-6 border-2 border-cyan-500/30">
            ...
            <div className="space-y-3 text-text-primary">
              <div className="bg-glass-dark p-4 rounded-lg border-l-4 border-green-500">
              ...
              <div className="bg-glass-dark p-4 rounded-lg border-l-4 border-blue-500">
              ...
              <div className="bg-glass-dark p-4 rounded-lg border-l-4 border-purple-500">
              ...
              <div className="bg-glass-dark p-4 rounded-lg border-l-4 border-yellow-500">
              ...
              <div className="bg-glass-dark p-4 rounded-lg border-l-4 border-red-500">
              ...
              <div className="bg-glass-dark p-4 rounded-lg border-l-4 border-cyan-500">
