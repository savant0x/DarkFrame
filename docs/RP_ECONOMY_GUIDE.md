...
1. [What are Research Points?](#what-are-research-points)
2. [How to Earn RP](#how-to-earn-rp)
3. [What to Spend RP On](#what-to-spend-rp-on)
4. [VIP Benefits](#vip-benefits)
5. [Daily Harvest Milestones](#daily-harvest-milestones)
6. [Progression Timeline](#progression-timeline)
...
**Research Points (RP)** are the primary currency for unlocking advanced features in DarkFrame:
- **Flag Tracking System** (T1-T4 tiers)
- **Tech Tree Unlocks** (Bot Hunter, Bot Magnet, Fast Travel, etc.)
- **Unit Tier Unlocks** (T1-T6 prestige units)
- **Future Content** (Clan warfare upgrades, special abilities, etc.)

RP is earned through **normal gameplay** and cannot be lost (only spent on unlocks).
...
| Streak Days | Base RP | Streak Bonus | Total |
|-------------|---------|--------------|-------|
...
### **Level-Up Rewards** ⬆️
Earn RP every time you level up (scales with level):

- **Formula:** `Level × 5 RP` (capped at 500 RP)
- **Examples:**
  - Level 10 → 50 RP
  - Level 50 → 250 RP
  - Level 100+ → 500 RP (max)

### **PvP Battle Victories** ⚔️
Win battles to earn RP based on opponent strength:
...
### **Achievement Unlocks** 🏆
One-time RP bonuses for unlocking achievements:

| Achievement | RP Reward |
|-------------|-----------|
| WARLORD (1,000 battles won) | 100 RP |
| MASTER_BUILDER (500 factories) | 50 RP |
| ARMY_OF_DOOM (10k units) | 150 RP |
| CAPITALIST (1M metal/energy) | 100 RP |
| SHRINE_MASTER (10 shrines) | 50 RP |
| ANCIENT_EXPLORER (50 caves) | 200 RP |
| LEGENDARY_HERO (Level 100) | **250 RP** |
...
Track and steal enemy flags for territory control:

| Tier | Cost | Features |
|------|------|----------|
| T1 | 500 RP | Basic tracking (1 tile radius) |
| T2 | 1,500 RP | Extended tracking (3 tile radius) |
...
VIP subscription provides **+50% RP on ALL sources**:

### **Daily Earning Comparison**
...
### **Flag System Unlock Timeline**

**Casual Player** (500-2,000 harvests/day):
- **Flag T1:** 2-3 days
- **Flag T2:** 1 week
- **Flag T3:** 2-3 weeks
- **Flag T4:** 4-6 weeks (VIP required)

**Active Player** (Full map daily):
- **Flag T1:** Same day
- **Flag T2:** Same day
- **Flag T3:** 1 day
- **Flag T4:** 2 days (VIP required)

**VIP Player** (Full map daily):
- **Flag T1:** Same day (3,000+ RP surplus)
- **Flag T2:** Same day (1,500+ RP surplus)
...
4. **Level Up Efficiently**
   ...
   - Focus on XP-rich activities (battles, factories)

5. **Complete Achievements**
   - One-time boosts that add up quickly
   - Check achievement panel regularly

### **Common Mistakes to Avoid**

❌ **Don't ignore milestones** - Every harvest counts, even partial maps give RP  
❌ **Don't forget daily login** - Missing a day breaks your streak  
❌ **Don't rush spending** - Plan your RP spending (Flag T1→T2→T3 is optimal)  
❌ **Don't neglect battles** - Easy RP from daily PvP victories  
❌ **Don't overlook VIP** - +50% RP is massive value for active players  

### **Optimal Spending Priority**

**For New Players:**
1. **Flag T1** (500 RP) - Basic tracking unlocked
2. **Flag T2** (1,500 RP) - Extended tracking
3. **Tier 2 Units** (1,000 RP) - Stronger army
4. **Flag T3** (5,000 RP) - Advanced tracking
5. **Bot Hunter** (2,500 RP) - Efficient farming
...
### **Q: Does VIP bonus apply to purchased RP?**
**A:** Yes! VIP gets +20% bonus on all shop RP purchases (separate from +50% earning bonus).

### **Q: When does my login streak reset?**
**A:** If you don't log in within 24 hours of your last login, your streak breaks and resets to 0.

---

## 📞 **Need Help?**

- **Bug Reports:** Use `/help` command in-game
- **Balance Suggestions:** Contact admin via Discord
- **Payment Issues:** Email support with transaction ID

---

**Happy Farming! 🌾💎**

*Remember: This game rewards consistency and strategy over pay-to-win. Every player can access all content through dedicated play!*
