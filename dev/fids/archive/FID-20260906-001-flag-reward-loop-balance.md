...
**Status:** closed — Option A implemented + live-verified (pass 7); close-out audit 2026-09-15 confirms `lib/flagBonusService.ts` + challenge/claim/flee routes live (later flag evolution belongs to later FIDs).
