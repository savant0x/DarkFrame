...
**Filename:** `FID-20260912-063-autofarm-move-fix.md`
**ID:** FID-20260912-063
**Severity:** HIGH
**Status:** closed
**Created:** 2026-09-12

> Close-out note (2026-09-15): shipped; the extractor was later renamed
> `extractNewPosition` → `extractMovePosition` (pinned by
> `__tests__/utils/autoFarmPosition.test.ts`, green). File text retains the
> original name as history.
