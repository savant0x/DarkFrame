...
- **Commit hash (G2 — required for `closed`):** `f21f6f1` (pre-merge hash; canonical: PR #41) — `fix(shim): real update/delete counts, working $pull, true $addToSet (FID-20260914-004)` (path-scoped: 13 files — shim, 2 new test files, 3 sweep-fixed routes, 5 verification scripts, FID, SCOPE surgical, session record)
...
**Final status:** closed (implemented + live-verified 2026-09-14; committed as `f21f6f1` 2026-09-14; closed per G2; canonical: PR #41)
