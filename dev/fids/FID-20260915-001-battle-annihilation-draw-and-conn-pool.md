...
- **Commit hash (G2):** `4237f51` (umbrella multi-stream commit, 2026-09-15; pre-merge hash — canonical: PR #41 — Phases 1–2 + restore; Phase 3 rebalance remains an open proposal awaiting operator approval)
